...
?>
	...
	<div class="row">
		...
		<div class="col-md-6 col-lg-6">		
			<label class="control-label">Company/Shop/Seller name</label>
			<span id='idcompany_name' style="color:red;"></span>
			<input name="company_name" id="company_name" class="form-control" type="text" placeholder="Company/Shop/Seller name" value="<?php echo $rsedit['company_name']; ?>">
		</div>
	</div>
<?php

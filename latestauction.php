...
<div class="col-md-4">
	<figure class="card card-product">
		<div class="img-wrap" style="padding-top: 0.5em;">
			<center>
				<a href="single.php?productid=<?php echo $rsproduct[0]; ?>"><img src="<?php echo $imgname; ?>" alt=" " class="img-responsive"style="height: 200px; width:200px;" /></a>
			</center>
		</div>

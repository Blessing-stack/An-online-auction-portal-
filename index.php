...
<div class="col">
	...
	<div class="single-product-wrap">
		<div class="product-image box"  style="height:300px;width:900%;">
			<a href="single.php?productid=<?php echo $rsproduct[0]; ?>">
				<img class="primary-image" src="<?php echo $imgname; ?>" alt=""  style="width:300px; height:300px">
...
<div class="col">
	<!-- single-product-wrap start -->
	<div class="single-product-wrap">
		<div class="product-image box"  style="height:300px;width:90%;">
			<a href="single.php?productid=<?php echo $rsproduct[0]; ?>">
				<img class="primary-image" src="<?php echo $imgname; ?>" alt=""  style="width:300px; height: 300px;">
				<?php /*<img class="secondary-image" src="<?php echo $imgname; ?>" alt=""> */ ?>
			</a>

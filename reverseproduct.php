...
if(isset($_POST['submit']))
{
	...
	{ 
		...
		if(mysqli_affected_rows($con) == 1)
		{
			echo "<script>alert('Reverse Product record inserted successfully..');</script>";
...
function validateform()
{
	...
	{
		document.getElementById("idproduct_cost").innerHTML ="Product cost should be more than <?php echo $ $currencysymbol; ?> 100....";	
		i=1;		
	}

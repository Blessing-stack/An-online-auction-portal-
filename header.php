                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-2 col-md-3 md-custom-12">
                                <!-- logo start -->
                                <div class="logo">
                                    <a href="index.php"><img src="<?php echo $rswebconfig['web_logo']; ?>" alt="" style="width: 200px;height: 60px;"></a>
                                </div>
                                <!-- logo end -->
                            </div>
...
<div class="top-dropdown">
	...
	?>
		...
		<li><a href="messagebox.php">Chat</a></li>
...
<li><a href="viewbillingcustomer.php">View Trasaction</a></li>
	...
	?>
		...
		<li class="drodown-show"><a href="#"> Users <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting" style="width: 215px;">
			<?php
			...
			?>
				<li><a href="viewcustomer.php?status=Pending">View Pending Customers</a></li>
				<li><a href="viewcustomer.php?status=Active">View Active Customers</a></li>
				<li><a href="viewcustomer.php?status=Suspend">View Suspended Customers</a></li>
			</ul>
		</li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>08108572125 </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
...
<div class="slider-main-area">
	<div class="slider-active owl-carousel">
		...
		<div class="slider-wrapper" style="background:url(img/slider/c.jpg) no-repeat;width: 100%; background-size:cover;" >
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							...
							<p>The Best Platform To Get Your Household Items.....</p>
		...
		<!-- slider-wrapper end -->
		<!-- slider-wrapper start -->
		<div class="slider-wrapper" style="background-image:url(img/slider/u.jpg);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
		...
		<!-- slider-wrapper end -->
		<!-- slider-wrapper start -->
		<div class="slider-wrapper" style="background-image:url(img/slider/y.jpg);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">

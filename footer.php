                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="about-us-footer">
                                    <div class="footer-logo">
                                        <a href="#"><img src="<?php echo $rswebconfig['web_logo']; ?>" alt=""></a>
                                    </div>
                                    <div class="footer-info">
                                        <p class="phone">08108572125</p>
                                    </div>
                                </div>
                            </div>
...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> Online Auction<br> Enugu<br>Nigeria</p>
                                                <p>Call us: <span>08108572125 </span></p>
                                                <p>Email us: <span>igweblessing6@gmail.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>

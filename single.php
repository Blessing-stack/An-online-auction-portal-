            ...
            <div class="product-info">
              <div class="product-gallery">
                ...
                <div class="product-gallery-featured">
                  <img src="imgproduct/<?php echo $arr_product_image[0]; ?>" alt="" id="imgproduct"  data-toggle="modal" data-target="#exampleModal" onclick="fun_load_img('<?php echo $rsproduct['product_name']; ?>')">
                </div>
              </div>
...
$i=0;	
	?><?php
			...
			while($rsproduct = mysqli_fetch_array($qsqlproduct))
			{
				...
				if(count($rsproduct['product_image']) == 0)
				{
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="productzoomtitle"></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <img src="" id="productzoomimg" STYLE="WIDTH: 100%;">
      </div>
    </div>
  </div>
</div>
<script>
//productzoomid productzoomimg
function fun_load_img(productzoomtitle)
{
	$("#productzoomtitle").html(productzoomtitle);
	 imgsrc = $('#imgproduct').attr('src')
	$("#productzoomimg").attr("src", imgsrc);
	//imgproduct fun_load_img
}
</script>
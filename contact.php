...
if(isset($_POST['submit']))
{
	...
	$owneremailid="igweebele@gmail.com";
	$title = "Enquiry Mail";
	$msg = "
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 plr-0">
                            <div class="contact-address-area">
                                ...
                                <ul>
                                    <li>
                                        <i class="fa fa-fax">&nbsp;</i> Address : Online Auction,Enugu Nigeria</li>
                                    <li>
                                        <i class="fa fa-phone">&nbsp;</i> igweebele@gmail.com</li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>&nbsp;+234818572125</li>
                                </ul>
                            </div>
                        </div>

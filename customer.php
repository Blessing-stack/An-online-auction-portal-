...
if(isset($_POST['submit']))
{
	if(isset($_GET['editid']))
	{
		...
		$sql = "UPDATE customer SET customer_fname='$_POST[customer_fname]',customer_lname='$_POST[customer_lname]',email_id='$_POST[email_id]',password='$_POST[password]',address='$_POST[address]',state='$_POST[state]',city='$_POST[city]',mobile_no='$_POST[mobile_no]',note='$_POST[note]',status='$_POST[status]' WHERE  customer_id='$_GET[editid]'";
	...
	{
	$sql = "INSERT INTO customer(customer_fname,customer_lname,email_id,password,address,state,city,landmark,pincode,mobile_no,note,status) VALUES('$_POST[customer_fname]','$_POST[customer_lname]','$_POST[email_id]','$_POST[password]','$_POST[address]','$_POST[state]','$_POST[city]','$_POST[postalcode]','$_POST[mobile_no]','$_POST[note]','$_POST[status]')";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
...
<div class="col-lg-12">
	<p class="single-form-row">
		<label>Postalcode</label> <span class="errormsg"  id="errpostalcode"></span>
		<input type="text" name="postalcode" id="postalcode" class="form-control" value="<?php echo $rsedit['postalcode']; ?>" >
	</p>
</div>
...
<div class="col-lg-12">
	<p class="single-form-row">
		...
		<input type="text" name="mobile_no" id="mobile_no" class="form-control" value="+2<?php echo $rsedit['mobile_no']; ?>" >
	</p>
</div>
...
function validatecustomer()
{
	...
	{
		document.getElementById("errpostalcode").innerHTML="PIN Code should contain 6 digits..";
		errchk = "True";
	}
	if(!document.getElementById("postalcode").value.match(numericExp))
	{
		document.getElementById("errpostalcode").innerHTML = "PIN code should contain digits....";
		errchk = "True";
	}
	if(document.getElementById("postalcode").value == "")
	{
		document.getElementById("errpostalcode").innerHTML="PIN Code should not be empty..";
		errchk = "True";
	}
